...
# Ao criar um conjunto, caso seja adicionado um valor ja existente, o mesmo será
...
# OBS: Caso o valor não seja encontrado sera gerado o erro KeyError. Nenhum valor é retornado.
...
# contendo etudantes do curso de Java.
...
# Precisamos gerar um conjunto com nomes ne estudantes únicos

# Forma 1 - Utilizando union

unicos1 = estudantes_python.union(estudantes_java)
# {'Patricia', 'Marcos', 'Ellen', 'Guilherme', 'Julia', 'Fernando', 'Ana', 'Gustavo', 'Pedro'}
# unicos1 = estudantes_java.union(estudantes_python)
# {'Ellen', 'Ana', 'Patricia', 'Julia', 'Marcos', 'Fernando', 'Gustavo', 'Guilherme', 'Pedro'}
print(unicos1)
