...
é bom fazer uma verificção para que a função seja simplificada.
...
# curso.append('Mais dados...')  #AttributeEror
# print(curso)
 ...
 * nome_da_funcao -> SEMPRE com letras minúsculas, e se for nome composto, separada por underline (Snake case);
 * parametros_de_entrada -> Opicionais, onde tendo mais de um, cada um separado por vírgula, podendo ser opicionais 
ou não;
 * bloco_da_funcao -> Também chamado de corpo da função ou implementação, é onde o processamento da função acontece.
Neste bloco, pode ter ou não retorno da função.

OBS: Veja que para definir uma funão, utilizamos a palavra reservada 'def' informando ao python que 
estamos definindo uma função. Também abrimos o bloco de código com o já conhecido dois pontos : que é 
utilizado em Python pra definir blocos.
"""
